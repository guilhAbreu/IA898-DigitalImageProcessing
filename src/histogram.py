...
if testing:
    ...
    get_ipython().run_line_magic('timeit', 'h = ia.histogram(f)')
    get_ipython().run_line_magic('timeit', 'h1 = ia.histogram_eq(f)')
    get_ipython().run_line_magic('timeit', 'h2 = ia.histogram_eq1(f)')
